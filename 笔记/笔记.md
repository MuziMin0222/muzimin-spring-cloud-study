...
- 创建ZooKeeper 挂载目录（数据挂载目录、配置挂载目录和日志挂载目录）
 # 数据挂载目录
mkdir -p /Users/muzimin/opt/docker/zookeeper/data
# 配置挂载目录
mkdir -p /Users/muzimin/opt/docker/zookeeper/conf 
# 日志挂载目录
mkdir -p /Users/muzimin/opt/docker/zookeeper/logs
- 启动zookeeper容器
docker run -d \
  --name zookeeper \
  --privileged=true \
  -p 2181:2181 \
  -v /Users/muzimin/opt/docker/zookeeper/data:/data \
  -v /Users/muzimin/opt/docker/zookeeper/conf:/conf \
  -v /Users/muzimin/opt/docker/zookeeper/logs:/datalog \
  zookeeper:3.4.9
...
[cloud-07-payment-zk-8003]
[zk: localhost:2181(CONNECTED) 3] ls /services/cloud-07-payment-zk-8003
[24719bda-af56-46a8-9c97-492364aa2569]
[zk: localhost:2181(CONNECTED) 4] get /services/cloud-07-payment-zk-8003/24719bda-af56-46a8-9c97-492364aa2569
{"name":"cloud-07-payment-zk-8003","id":"24719bda-af56-46a8-9c97-492364aa2569","address":"localhost","port":8003,"sslPort":null,"payload":{"@class":"org.springframework.cloud.zookeeper.discovery.ZookeeperInstance","id":"application-1","name":"cloud-07-payment-zk-8003","metadata":{}},"registrationTimeUTC":1714100798148,"serviceType":"DYNAMIC","uriSpec":{"parts":[{"value":"scheme","variable":true},{"value":"://","variable":false},{"value":"address","variable":true},{"value":":","variable":false},{"value":"port","variable":true}]}}
cZxid = 0x7
ctime = Fri Apr 26 03:06:39 GMT 2024
mZxid = 0x7
mtime = Fri Apr 26 03:06:39 GMT 2024
pZxid = 0x7
cversion = 0
dataVersion = 0
aclVersion = 0
ephemeralOwner = 0x18f1841dd100001
dataLength = 534
numChildren = 0
...
* docker images
  * 查看下载的镜像，获取到imageid
* docker run --name sentinel -d -p 8858:8858 -d imageid
* localhost:8858访问dashboard
  * 默认的账号密码都是sentinel
...
docker安装：docker run --name seata-server -p 8091:8091 -p 7091:7091 seataio/seata-server:1.5.0
